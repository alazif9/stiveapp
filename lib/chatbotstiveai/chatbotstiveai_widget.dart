...
class ChatbotstiveaiWidget extends StatefulWidget {
  const ChatbotstiveaiWidget({super.key, required this.threadId});
      ...
      child: Scaffold(
          ...
          actions: [
            Padding(
              ...
              child: FlutterFlowIconButton(
                borderRadius: 20.0,
                buttonSize: 40.0,
                icon: Icon(Icons.more_vert, color: Colors.white, size: 24.0),
                onPressed: () async {
        ...
        body: SafeArea(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(color: Color(0xFF0D1F2D)),
            child: Stack(
              alignment: AlignmentDirectional(0.0, 0.0),
              children: [
                Container(
                  ...
                  Align(
                    ...
                    child: SafeArea(
                      child: Container(
                        ...
                        height: MediaQuery.sizeOf(context).height * 0.9,
                        decoration: BoxDecoration(color: Color(0x89FFFFFF)),
                        alignment: AlignmentDirectional(0.0, 0.0),
                        child: Column(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      if (_model.chatHistorico.length > 0)
                                        Builder(
                                          builder: (context) {
                                            final chat = _model.chatHistorico
                                                .toList();
                                ...
                                onPressed: () async {
                                  ...
                                  _model.apiResultza3 =
                                      await TranscricaoimagemCall.call(
                                        file: _model
                                            .uploadedLocalFile_uploadData7ko,
                                      );
                              ...
                              Align(
                                ...
                                child: FlutterFlowIconButton(
                                  ...
                                  onPressed: () async {
                                    ...
                                    _model.addToChatHistorico(
                                      ChatStruct.maybeFromMap(<String, dynamic>{
                                        'role': 'user',
                                    ...
                                    _model
                                        .returnAssistent = await OpenAINovoGroup
                                    ...
                                    while (!_model.isComplete) {
                                      _model
                                          .apiResultxi8 = await OpenAINovoGroup
                                    ...
                                    safeSetState(() {});
                                    if (functions.hasSectionEquals(
                                          _model.section,
                                        ) ==
                                        true) {
                                      _model.section = functions
                                          .getSiglaFromApiResponse(
                                            _model.section,
                                          );
                                      safeSetState(() {});
                                      ...
                                      if ((_model.postarMsg2?.statusCode ??
                                              200) ==
                                          402) {
                                        ScaffoldMessenger.of(
                                          context,
